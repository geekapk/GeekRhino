...
public class Test262SuiteTest {
    ...
    static Map<Integer, Map<String, Script>> HARNESS_SCRIPT_CACHE =
            new HashMap<Integer, Map<String, Script>>();
            ...
            new ShellContextFactory() {
                ...
                protected GeneratedClassLoader createClassLoader(ClassLoader parent) {
                    return new AndroidClassLoader(
                            parent, new File(System.getProperty("java.io.tmpdir", "."), "classes"));
                }
            };
    ...
    public static Collection<Object[]> test262SuiteValues() throws IOException {
        ...
        for (File jsTest : tests) {
            ...
            List<String> flags =
                    header.containsKey("flags")
                            ? (List<String>) header.get("flags")
            ...
            for (int optLevel : OPT_LEVELS) {
                ...
                if (!flags.contains("noStrict")) {
                    result.add(
                            new Object[] {
                                jsTest.getPath(), jsFileStr, harnessFiles, optLevel, true, errorType
                            });
                }
            }
        }
