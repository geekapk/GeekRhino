...
public class RequireTest extends TestCase {
    ...
    public void testRelativeId() throws Exception {
        ...
        cx.evaluateString(
                scope,
                TestUtils.readAsset(dir + File.separator + "testRelativeId.js"),
                "testRelativeId.js",
                1,
                null);
    }
    ...
    public void testSetMainForAlreadyLoadedModule() throws Exception {
        ...
        cx.evaluateString(
                scope,
                TestUtils.readAsset(dir + File.separator + "testSetMainForAlreadyLoadedModule.js"),
                ...
                new ModuleScriptProvider() {
                    ...
                    public ModuleScript getModuleScript(
                        ...
                        return new ModuleScript(
                                cx.compileString(TestUtils.readAsset(f), moduleId, 1, null),
                                f.toURI(),
                                dir.toURI());
                    }
                },
    ...
    private URI getDirectory() throws URISyntaxException {
        final String jsFile =
                TestUtils.readAsset(
                        getClass().getPackage().getName() + File.separator + "testSandboxed.js");
