...
public final class Dex {
    ...
    /**
     * Creates a new dex from the contents of {@code bytes}. This API supports both {@code .dex} and
     * {@code .odex} input. Calling this constructor transfers ownership of {@code bytes} to the
     * returned Dex: it is an error to access the buffer after calling this method.
     */
    ...
    /**
     * Look up a field id name index from a field index. Cheaper than: {@code
    ...
    /**
     * Look up a field id type index from a field index. Cheaper than: {@code
    ...
    /**
     * Look up a method id declaring class index from a method index. Cheaper than: {@code
    ...
    /**
     * Look up a method id name index from a method index. Cheaper than: {@code
    ...
    /**
     * Look up a parameter type ids from a method index. Cheaper than: {@code
    ...
    /**
     * Look up a method id return type index from a method index. Cheaper than: {@code
