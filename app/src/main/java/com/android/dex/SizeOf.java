...
public final class SizeOf {
     ...
     * type_ids_size uint type_ids_off uint proto_ids_size uint proto_ids_off uint field_ids_size
     * uint field_ids_off uint method_ids_size uint method_ids_off uint class_defs_size uint
     * class_defs_off uint data_size uint data_off uint
     */
