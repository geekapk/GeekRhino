...
public abstract class BaseMachine implements Machine {
    ...
    /**
     * Gets the target local register spec of the current operation, if any. The local target spec
     * is the combination of the values indicated by a previous call to {@link #localTarget} with
     * the type of what should be the sole result set by a call to {@link #setResult} (or the
     ...
     *
     * <p><b>Note:</b> If there is more than one result value, the others may be added by using
     * {@link #addResult}.
     *
