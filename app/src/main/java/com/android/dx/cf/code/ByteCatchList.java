...
public final class ByteCatchList extends FixedSizeList {
    ...
    /**
     * Gets the list of items active at the given address. The result is automatically made
     * immutable.
     *
    ...
    /**
     * Returns a target list corresponding to this instance. The result is a list of all the
     * exception handler addresses, with the given {@code noException} address appended if
     * appropriate. The result is automatically made immutable.
     *
    ...
    public static class Item {
         ...
         *
         * @return {@code non-null;} the exception class; {@link CstType#OBJECT} if this entry
