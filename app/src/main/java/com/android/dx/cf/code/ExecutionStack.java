...
public final class ExecutionStack extends MutabilityControl {
    ...
    /**
     * Replaces all the occurrences of the given uninitialized type in this stack with its
    ...
    /**
     * Peeks at the {@code n}th element down from the top of the stack, returning the type per se,
     * as opposed to the <i>type-bearer</i>. This method is just a convenient shorthand for {@code
     * peek(n).getType()}.
     *
     * @see #peek
     */
    ...
    /**
     * Changes an element already on a stack. This method is useful in limited contexts,
     * particularly when merging two instances. As such, it places the following restriction on its
     * behavior: You may only replace values with other values of the same category.
     *
     * @param n {@code >= 0;} which element to change, where {@code 0} is the top element of the
     *     stack
