...
public final class LocalVariableList extends FixedSizeList {
    ...
    /**
     * Returns an instance which is the result of merging the two given instances, where one
     * instance should have only type descriptors and the other only type signatures. The merged
     * result is identical to the one with descriptors, except that any element whose {name, index,
     * start, length} matches an element in the signature list gets augmented with the corresponding
     ...
     * com.android.dx.cf.code.LocalVariableList.Item} in all respects but the type descriptor and
     * signature, if any.
     *
     * @param item {@code non-null;} local variable information to match
     * @return {@code null-ok;} the corresponding local variable information stored in this
     *     instance, or {@code null} if there is no matching information
     */
     ...
     * @return {@code null-ok;} the associated local variable information, or {@code null} if none
     *     is known
     */
    ...
    public static class Item {
        ...
        /**
         * Gets the variable's type signature. Private because if you need this, you want
         * getLocalItem() instead.
         *
        ...
        /**
         * Constructs and returns an instance which is identical to this one, except that the
         * signature is changed to the given value.
         *
        ...
        /**
         * Gets whether this instance matches (describes) the given other instance exactly in all
         * fields except type descriptor and type signature.
         *
