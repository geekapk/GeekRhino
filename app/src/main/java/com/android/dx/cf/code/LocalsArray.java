...
public abstract class LocalsArray extends MutabilityControl implements ToHuman {
    ...
    /**
     * Replaces all the occurrences of the given uninitialized type in this array with its
     ...
     * invalidated by the operation. In case of either category, if the <i>previous</i> local
     * contains a category-2 value, then it too is invalidated by this operation.
     *
     ...
     *     local is invalid; (b) the local contains an uninitialized instance; (c) the local
     *     contains a category-2 value
     */
    ...
    /**
     * Merges this instance with a {@code LocalsSet} from a subroutine caller. To be used when
     * merging in the first block of a subroutine.
     *
    ...
    /**
     * Gets the locals set appropriate for the current execution context. That is, if this is a
     * {@code OneLocalsArray} instance, then return {@code this}, otherwise return {@code
     * LocalsArraySet}'s primary.
     *
