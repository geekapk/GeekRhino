...
public class LocalsArraySet extends LocalsArray {
    ...
    /**
     * The primary LocalsArray represents the locals as seen from the subroutine itself, which is
     * the merged representation of all the individual locals states.
     */
    ...
    /**
     * Gets the {@code LocalsArray} instance for a specified subroutine caller label, or null if
     * label has no locals associated with it.
     *
    ...
    /**
     * Returns a LocalsArray instance representing the locals state that should be used when
     * returning to a subroutine caller.
     *
     * @param subLabel {@code >= 0;} A calling label of a subroutine
     * @return {@code null-ok;} an instance for this subroutine, or null if subroutine is not in
     *     this set.
     */
