...
public final class Merger {
     ...
     * assume anything about class hierarchy other than that the type {@code Object} is the
     * supertype of all reference types and all arrays are assignable to {@code Serializable} and
     * {@code Cloneable}.
     *
