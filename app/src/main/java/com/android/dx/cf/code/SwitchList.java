...
public final class SwitchList extends MutabilityControl {
    ...
    /**
     * Gets the indicated target. Asking for the target at {@code size()} returns the default
     * target.
     *
     * @param n {@code >= 0, <= size();} which index
    ...
    /**
     * Sets the default target. It is only valid to call this method when all the non-default
