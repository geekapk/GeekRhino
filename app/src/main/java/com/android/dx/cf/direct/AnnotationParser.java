...
public final class AnnotationParser {
     ...
     */
    private AnnotationsList parseAnnotationsList(AnnotationVisibility visibility)
            throws IOException {
    ...
    /**
     * Helper which will throw an exception if the given number of bytes is not available to be
     * read.
     *
