...
public class ClassPathOpener {
    ...
    public interface Consumer {
         ...
         * @return true on success. Result is or'd with all other results from {@code
         *     processFileBytes} and returned to the caller of {@code process()}.
         */
     ...
     * @param consumer {@code non-null;} callback interface
     */
    public ClassPathOpener(
            String pathname, boolean sort, FileNameFilter filter, Consumer consumer) {
