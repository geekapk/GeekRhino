...
public class DirectClassFile implements ClassFile {
     ...
     *
     * <p>See http://en.wikipedia.org/wiki/Java_class_file for an up-to-date list of version
     * numbers. Currently known (taken from that table) are:
     *
     * <p>J2SE 7.0 = 51 (0x33 hex), J2SE 6.0 = 50 (0x32 hex), J2SE 5.0 = 49 (0x31 hex), JDK 1.4 = 48
     * (0x30 hex), JDK 1.3 = 47 (0x2F hex), JDK 1.2 = 46 (0x2E hex), JDK 1.1 = 45 (0x2D hex).
     *
     * <p>Valid ranges are typically of the form "A.0 through B.C inclusive" where A <= B and C >=
     * 0, which is why we don't have a CLASS_FILE_MIN_MINOR_VERSION.
     */
    ...
    /**
     * whether to be strict about parsing; if {@code false}, this avoids doing checks that only
     * exist for purposes of verification (such as magic number matching and path-package
    ...
    /**
     * {@code null-ok;} the class file field {@code this_class}, interpreted as a type constant;
     * only ever {@code null} before the file is successfully parsed
     */
    ...
    /**
     * {@code null-ok;} the class file field {@code fields}; only ever {@code null} before the file
    ...
    /**
     * Constructs and returns an instance of {@link TypeList} whose data comes from the bytes of
     * this instance, interpreted as a list of constant pool indices for classes, which are in turn
    ...
    /**
     * Gets the class file field {@code minor_version}, but without doing any checks or parsing
     * first.
     *
    ...
    /**
     * Gets the class file field {@code major_version}, but without doing any checks or parsing
     * first.
     *
     ...
     */
    private boolean isGoodVersion(int magic, int minorVersion, int majorVersion) {
    ...
    private void parse0() {
        ...
        if (at != bytes.size()) {
            throw new ParseException(
                    "extra bytes at end of class file, " + "at offset " + Hex.u4(at));
        }
