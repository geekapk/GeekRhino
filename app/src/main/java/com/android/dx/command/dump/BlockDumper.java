...
public class BlockDumper extends BaseDumper {
    ...
    /**
     * {@code null-ok;} the class file object being constructed; becomes non-null during {@link
     * #dump}
     */
    ...
    /**
     * Dumps the given array, interpreting it as a class file and dumping methods with indications
     * of block-level stuff.
     *
    ...
    public static void dump(
            byte[] bytes, PrintStream out, String filePath, boolean rop, Args args) {
