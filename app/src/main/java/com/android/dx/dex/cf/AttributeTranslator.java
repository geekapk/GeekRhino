...
/*package*/ class AttributeTranslator {
    ...
    /**
     * Gets the annotations out of a given method, similar to {@link #getAnnotations}, also
     * including an annotation for the translation of the method-specific attribute {@code
     * Exceptions}.
     *
     * @param method {@code non-null;} the method in question
     * @return {@code non-null;} the set of annotations, which may be empty
    ...
    /**
     * Gets the {@code Signature} attribute out of a given {@link AttributeList}, if any,
     * translating it to an annotation.
     *
     * @param attribs {@code non-null;} the attributes list to search in
     * @return {@code null-ok;} the converted {@code Signature} annotation, if there was an
     ...
     * {@code EnclosingMethod} annotation; if not, this returns an {@code EnclosingClass}
     * annotation.
     *
     * @param attribs {@code non-null;} the attributes list to search in
    ...
    /**
     * Gets the parameter annotations out of a given method. This combines both visible and
     * invisible annotations into a single result set.
     *
     * @param method {@code non-null;} the method in question
     ...
     *
     * @param cf {@code non-null;} the class in question
     * @return {@code null-ok;} an appropriately-constructed {@code AnnotationDefault} annotation,
