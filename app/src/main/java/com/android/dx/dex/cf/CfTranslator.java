...
public class CfTranslator {
    ...
    /**
     * Performs the main act of translation. This method is separated from {@link #translate} just
     * to keep things a bit simpler in terms of exception handling.
     *
     * @param cf {@code non-null;} the class file
     * @param bytes {@code non-null;} contents of the file
     * @param cfOptions options for class translation
    ...
    private static ClassDefItem translate0(
        ...
        OptimizerOptions.loadOptimizeLists(
            ...
            try {
                ...
                if (isNative || isAbstract) {
                    ...
                    if (cfOptions.optimize && OptimizerOptions.shouldOptimize(canonicalName)) {
                        ...
                        rmeth =
                                Optimizer.optimize(
                                        rmeth, paramSize, isStatic, cfOptions.localInfo, advice);
                    ...
                    code =
                            RopTranslator.translate(
                                    rmeth, cfOptions.positionInfo, locals, paramSize, dexOptions);
    ...
    private static void updateDexStatistics(
        ...
        DalvCode optCode =
                RopTranslator.translate(
                        optRmeth, cfOptions.positionInfo, locals, paramSize, dexOptions);
        DalvCode nonOptCode =
                RopTranslator.translate(
                        nonOptRmeth, cfOptions.positionInfo, locals, paramSize, dexOptions);
