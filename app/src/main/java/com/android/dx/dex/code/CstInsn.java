...
public final class CstInsn extends FixedSizeInsn {
    ...
    /**
     * {@code >= -1;} the constant pool index for the class reference in {@link #constant} if any,
     * or {@code -1} if not yet set
     */
    ...
    /**
     * Gets the constant's class index. It is only valid to call this after {@link #setClassIndex}
     * has been called.
     *
     ...
     * with reference constants that this method should ever be called. It is only valid to call
     * this method once per instance.
     *
