...
public final class DalvCode {
    ...
    /**
     * Assign indices in all instructions that need them, using the given callback to perform
     * lookups. This must be called before {@link #getInsns}.
     *
    ...
    public static interface AssignIndicesCallback {
         ...
         * @return {@code >= -1;} the index or {@code -1} if the constant shouldn't actually be
         *     reified with an index
         */
