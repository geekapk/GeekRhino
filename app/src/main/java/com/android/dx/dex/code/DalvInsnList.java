...
public final class DalvInsnList extends FixedSizeList {
     ...
     * greater than the largest observed register+ category because the method this code block
     * exists in may specify arguments that are unused by the method.
     */
     ...
     * @param regCount count, in register-units, of the number of registers this code block
     *     requires.
    ...
    /**
     * Gets the size of this instance, in 16-bit code units. This will only return a meaningful
     * result if the instructions in this instance all have valid addresses.
     *
    ...
    public void writeTo(AnnotatedOutput out) {
        ...
        if (written != codeSize()) {
            throw new RuntimeException(
                    "write length mismatch; expected "
                            + codeSize()
                            + " but actually wrote "
                            + written);
        }
     ...
     * @param verbose whether to be verbose; verbose output includes lines for zero-size
     *     instructions and explicit constant pool indices
     */
