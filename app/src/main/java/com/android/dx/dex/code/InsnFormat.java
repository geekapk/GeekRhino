...
public abstract class InsnFormat {
     ...
     * This includes such things as counting register arguments, checking register ranges, and
     * making sure that additional arguments are of appropriate types and are in-range. If this
     * format has a branch target but the instruction's branch offset is unknown, this method will
     * simply not check the offset.
     *
     * <p>Subclasses must override this method.
     *
     ...
     *
     * @param insn {@code non-null;} the instruction to check
     * @return {@code non-null;} a BitSet flagging registers in the register list that are
     *     compatible to this format
     */
    ...
    /**
     * Helper method to get an extended (16-bit) opcode out of an instruction, returning it as a
     * code unit. The opcode <i>must</i> be an extended opcode.
     *
