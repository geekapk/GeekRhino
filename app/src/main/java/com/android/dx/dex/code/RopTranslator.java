...
public final class RopTranslator {
    ...
    /**
     * true if the parameters to this method happen to be in proper order at the end of the frame
     * (as the optimizer emits them)
     */
    ...
    /**
     * Gets the complete register list (result and sources) out of a given rop instruction. For
     * insns that are commutative, have two register sources, and have a source equal to the result,
    ...
    private class TranslationVisitor implements Insn.Visitor {
        ...
        public void visitPlainCstInsn(PlainCstInsn insn) {
            ...
            if (ropOpcode == RegOps.MOVE_PARAM) {
                if (!paramsAreInOrder) {
                    ...
                    int param = ((CstInteger) insn.getConstant()).getValue();
                    RegisterSpec source =
                            RegisterSpec.make(regCount - paramSize + param, dest.getType());
         ...
         *
         * @return {@code null-ok;} result of move-result-pseudo at the beginning of primary
         *     successor
         */
    ...
    private class LocalVariableAwareTranslationVisitor extends TranslationVisitor {
         ...
         */
        public LocalVariableAwareTranslationVisitor(
                OutputCollector output, LocalVariableInfo locals) {
            super(output);
            this.locals = locals;
        }
        ...
        /**
         * Adds a {@link LocalStart} to the output if the given instruction in fact introduces a
         * local variable.
         *
         * @param insn {@code non-null;} instruction in question
         */
