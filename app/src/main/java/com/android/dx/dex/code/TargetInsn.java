...
public final class TargetInsn extends FixedSizeInsn {
     ...
     * -1}), and the target is initially {@code null}.
     *
     ...
     * (as a test; e.g. a {@code lt} test becomes a {@code ge}), and its branch target is replaced
     * by the one given, and all set-once values associated with the class (such as its address) are
     * reset.
     *
