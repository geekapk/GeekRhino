...
public final class Form35c extends InsnFormat {
    ...
    /**
     * Gets the number of words required for the given register list, where category-2 values count
     * as two words. Return {@code -1} if the list requires more than five words or contains
     * registers that need more than a nibble to identify them.
     *
    ...
    /**
     * Returns a register list which is equivalent to the given one, except that it splits
     * category-2 registers into two explicit entries. This returns the original list if no
