...
public final class AnnotationsDirectoryItem extends OffsettedItem {
    ...
    /**
     * Returns whether this item is a candidate for interning. The only interning candidates are
     * ones that <i>only</i> have a non-null set of class annotations, with no other lists.
     *
    ...
    /**
     * Sets the direct annotations on this instance. These are annotations made on the class, per
     * se, as opposed to on one of its members. It is only valid to call this method at most once
     * per instance.
     *
    ...
    public void addMethodAnnotations(
            CstMethodRef method, Annotations annotations, DexFile dexFile) {
    ...
    public void addParameterAnnotations(
            CstMethodRef method, AnnotationsList list, DexFile dexFile) {
    ...
    protected void place0(Section addedTo, int offset) {
        ...
        int elementCount =
                listSize(fieldAnnotations)
                        + listSize(methodAnnotations)
                        + listSize(parameterAnnotations);
