...
public final class ClassDataItem extends OffsettedItem {
    ...
    /**
     * Helper for {@link #encodeOutput}, which writes out the given size value, annotating it as
     * well (if annotations are enabled).
     *
     * @param file {@code non-null;} file this instance is part of
     * @param out {@code non-null;} where to write to
    ...
    /**
     * Helper for {@link #encodeOutput}, which writes out the given list. It also annotates the
     * items (if any and if annotations are enabled).
     *
     * @param file {@code non-null;} file this instance is part of
     * @param out {@code non-null;} where to write to
     * @param label {@code non-null;} the label for the purposes of annotation
