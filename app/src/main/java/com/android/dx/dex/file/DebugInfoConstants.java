...
public interface DebugInfoConstants {
     ...
     * is added should be considered the end of a method prologue (an appropriate place for a method
     * breakpoint).
     *
    ...
    /**
     * Sets the "epilogue_begin" state machine register, indicating that the next position entry
     * that is added should be considered the beginning of a method epilogue (an appropriate place
    ...
    /**
     * Sets the current file that that line numbers refer to. All subsequent line number entries
     * make reference to this source file name, instead of the default name specified in code_item.
     *
     * <p>Args:
     *
     * <ol>
