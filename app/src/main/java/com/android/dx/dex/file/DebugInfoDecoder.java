...
public class DebugInfoDecoder {
                ...
                case DBG_START_LOCAL_EXTENDED:
                    {
                        ...
                        LocalEntry le =
                                new LocalEntry(address, true, reg, nameIdx, typeIdx, sigIdx);
                ...
                case DBG_END_LOCAL:
                    {
                        ...
                        try {
                            ...
                            if (!prevle.isStart) {
                                throw new RuntimeException(
                                        "nonsensical " + "END_LOCAL on dead register v" + reg);
                            }
    ...
    /**
     * Validates an encoded debug info stream against data used to encode it, throwing an exception
     * if they do not match. Used to validate the encoder.
     *
    ...
    private static void validateEncode0(
        ...
        for (int i = 0; i < origSz; i++) {
            ...
            if (decodedEntry.reg != origEntry.getRegister()) {
                System.err.println(
                        "local register mismatch at orig " + i + " / decoded " + decodeAt);
                problem = true;
                break;
            }
            ...
            if (decodedEntry.isStart != origEntry.isStart()) {
                System.err.println(
                        "local start/end mismatch at orig " + i + " / decoded " + decodeAt);
                problem = true;
                break;
            }
            ...
            if ((decodedAddress != origEntry.getAddress())
                ...
                System.err.println(
                        "local address mismatch at orig " + i + " / decoded " + decodeAt);
                problem = true;
                break;
            }
