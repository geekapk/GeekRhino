...
public class DebugInfoItem extends OffsettedItem {
    ...
    /**
     * Writes annotations for the elements of this list, as zero-length. This is meant to be used
     * for dumping this instance directly after a code dump (with the real local list actually
