...
public final class DexFile {
     ...
     *
     * <p>This is package-scope in order to allow the {@link HeaderSection} to set itself up
     * properly.
     *
    ...
    /**
     * Gets the {@link IndexedItem} corresponding to the given constant, if it is a constant that
     * has such a correspondence, or return {@code null} if it isn't such a constant. This will
     * throw an exception if the given constant <i>should</i> have been found but wasn't.
     *
    ...
    /**
     * Calculates the signature for the {@code .dex} file in the given array, and modify the array
     * to contain it.
     *
