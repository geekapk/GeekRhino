...
public final class MixedItemSection extends Section {
     ...
     * @param alignment {@code > 0;} alignment requirement for the final output; must be a power of
     *     2
    ...
    /**
     * Adds an item to this instance. This will in turn tell the given item that it has been added
     * to this instance. It is invalid to add the same item to more than one instance, nor to add
     * the same items multiple times to a single instance.
     *
    ...
    /**
     * Writes an index of contents of the items in this instance of the given type. If there are
     * none, this writes nothing. If there are any, then the index is preceded by the given intro
     * string.
     *
     ...
     * {@code place}, it is that call which is responsible for setting the write size. This method
     * may only be called once per instance; subsequent calls will throw an exception.
     */
