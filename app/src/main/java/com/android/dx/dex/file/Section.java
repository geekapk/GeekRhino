...
public abstract class Section {
    ...
    /**
     * Gets the offset from the start of the file to this part. This throws an exception if the
     ...
     * particularly adding stuff to other sections. This method may only be called once per
     * instance; subsequent calls will throw an exception.
     */
    ...
    /**
     * Gets the collection of all the items in this section. It is not valid to attempt to change
     * the returned list.
     *
