...
public abstract class UniformItemSection extends Section {
    ...
    /**
     * Gets the item corresponding to the given {@link Constant}. This will throw an exception if
     * the constant is not found, including if this instance isn't the sort that maps constants to
     * {@link IndexedItem} instances.
     *
