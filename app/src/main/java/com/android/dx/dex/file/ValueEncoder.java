...
public final class ValueEncoder {
    ...
    /**
     * Writes out the encoded form of the given annotation, that is, as an {@code
     * encoded_annotation} and not including a {@code value_type} prefix. If the output stream keeps
     * (debugging) annotations and {@code topLevel} is {@code true}, then this method will write
    ...
    /**
     * Gets the colloquial type name and human form of the type of the given constant, when used as
     * an encoded value.
     *
     * @param cst {@code non-null;} the constant
