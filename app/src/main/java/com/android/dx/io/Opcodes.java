...
/**
 * All the Dalvik opcode value constants. See the related spec document for the meaning and
 * instruction format of each opcode.
 */
public final class Opcodes {
     ...
     * {@code 0x01..0xfe}, the range {@code 0x00ff..0xffff} where the low-order byte is either
     * {@code 0} or {@code 0xff}, and the special opcode values {@code SPECIAL_FORMAT} and {@code
     * NO_NEXT}. Note that not all of the opcode values that pass this test are in fact used. This
     * method is meant to perform a quick check to reject blatantly wrong values (e.g. when
