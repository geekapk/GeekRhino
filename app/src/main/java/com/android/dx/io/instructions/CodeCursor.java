...
public interface CodeCursor {
    /**
     * Gets the cursor. The cursor is the offset in code units from the start of the input of the
     * next code unit to be read or written, where the input generally consists of the code for a
     * single method.
     */
    public int cursor();
