...
public enum InstructionCodec {
    ...
    FORMAT_11N() {
        ...
        public void encode(DecodedInstruction insn, CodeOutput out) {
            out.write(
                    codeUnit(insn.getOpcodeUnit(), makeByte(insn.getA(), insn.getLiteralNibble())));
        }
    },
    ...
    FORMAT_10T() {
        ...
        public DecodedInstruction decode(int opcodeUnit, CodeInput in) throws EOFException {
            ...
            return new ZeroRegisterDecodedInstruction(
                    this, opcode, 0, null, baseAddress + target, 0L);
        }
    ...
    FORMAT_20BC() {
        ...
        public DecodedInstruction decode(int opcodeUnit, CodeInput in) throws EOFException {
            ...
            int index = in.read();
            return new ZeroRegisterDecodedInstruction(
                    this, opcode, index, IndexType.VARIES, 0, literal);
        }
    ...
    FORMAT_21T() {
        ...
        public DecodedInstruction decode(int opcodeUnit, CodeInput in) throws EOFException {
            ...
            return new OneRegisterDecodedInstruction(
                    this, opcode, 0, null, baseAddress + target, 0L, a);
        }
    ...
    FORMAT_22T() {
        ...
        public void encode(DecodedInstruction insn, CodeOutput out) {
            short relativeTarget = insn.getTargetUnit(out.cursor());
            out.write(
                    codeUnit(insn.getOpcode(), makeByte(insn.getA(), insn.getB())), relativeTarget);
        }
    },
    ...
    FORMAT_22S() {
        ...
        public void encode(DecodedInstruction insn, CodeOutput out) {
            out.write(
                    codeUnit(insn.getOpcode(), makeByte(insn.getA(), insn.getB())),
                    insn.getLiteralUnit());
        }
    },
    ...
    /**
     * Decodes an instruction specified by the given opcode unit, reading any required additional
     * code units from the given input source.
     */
    ...
    private static DecodedInstruction decodeRegisterList(
        ...
        switch (registerCount) {
            ...
            case 1:
                return new OneRegisterDecodedInstruction(
                        format, opcode, index, indexType, 0, 0L, a);
            case 2:
                return new TwoRegisterDecodedInstruction(
                        format, opcode, index, indexType, 0, 0L, a, b);
            case 3:
