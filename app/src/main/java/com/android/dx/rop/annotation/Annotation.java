...
public final class Annotation extends MutabilityControl implements Comparable<Annotation>, ToHuman {
    ...
    /**
     * Put an element into the set of (name, value) pairs for this instance. If there is a
     * preexisting element with the same name, it will be replaced by this method.
     *
    ...
    /**
     * Add an element to the set of (name, value) pairs for this instance. It is an error to call
     * this method if there is a preexisting element with the same name.
     *
    ...
    /**
     * Gets the set of name-value pairs contained in this instance. The result is always
     * unmodifiable.
     *
