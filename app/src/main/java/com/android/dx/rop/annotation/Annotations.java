...
public final class Annotations extends MutabilityControl implements Comparable<Annotations> {
    ...
    /**
     * Constructs an immutable instance which is the combination of the given instance with the
     * given additional annotation. The latter's type must not already appear in the former.
     *
