...
public final class AccessFlags {
    ...
    /**
     * Returns a human-oriented string representing the given access flags, as defined on classes
     * (not fields or methods).
     *
    ...
    /**
     * Returns a human-oriented string representing the given access flags, as defined on fields
     * (not classes or methods).
     *
     * @param flags the flags
     * @return {@code non-null;} human-oriented string
     */
    ...
    /**
     * Returns a human-oriented string representing the given access flags, as defined on methods
     * (not classes or fields).
     *
     * @param flags the flags
     * @return {@code non-null;} human-oriented string
     */
