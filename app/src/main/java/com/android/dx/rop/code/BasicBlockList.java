...
public final class BasicBlockList extends LabeledList {
    ...
    /**
     * Gets the total instruction count for this instance, ignoring mark-local instructions which
     * are not actually emitted.
     *
     * @return {@code >= 0;} the total instruction count
     */
    ...
    /**
     * Compares the catches of two blocks for equality. This includes both the catch types and
     * target labels.
     *
