...
public abstract class Insn implements ToHuman {
     ...
     * throw or if it merely doesn't handle any of its possible exceptions. To determine whether
    ...
    /**
     * Returns an instance that is just like this one, except that it has a catch list with the
     * given item appended to the end. This method throws an exception if this instance can't
     * possibly throw. To determine whether this instruction can throw, use {@link #canThrow}.
     *
    ...
    /**
     * Returns an instance that is just like this one, except that, if possible, the insn is
     * converted into a version in which a source (if it is a constant) is represented directly
     * rather than as a register reference. {@code this} is returned in cases where the translation
     * is not possible.
     *
     * @return {@code non-null;} an appropriately-constructed instance
     */
    ...
    /**
     * Returns the string form of this instance, with the given bit added in the standard location
     * for an inline argument.
     *
