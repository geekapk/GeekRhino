...
public final class RegOps {
     ...
     * be used in the first instruction of a block, and such blocks must be the start of an
     * exception handler.
     */
    ...
    /**
     * {@code T: any numeric type; r: int; x,y: T :: r = (x == y) ? 0 : (x > y) ? 1 : -1}
     * (Java-style "cmpl" where a NaN is considered "less than" all other values; also used for
    ...
    /**
     * {@code Tr, T0, T1...: any types; r: Tr; m: static method spec; y0: T0; y1: T1 ... :: r =
     * m(y0, y1, ...)} (call static method)
     */
    ...
    /**
     * {@code Tr, T0, T1...: any types; r: Tr; x: Object; m: interface (instance) method spec; y0:
     * T0; y1: T1 ... :: r = x.m(y0, y1, ...)} (call interface method)
     */
    ...
    /**
     * {@code T: Any type; r: T :: r = return_type}. <b>Note:</b> This opcode should only ever be
     * used in the first instruction of a block following an invoke-*.
     */
    public static final int MOVE_RESULT = 55;

    /**
     * {@code T: Any type; r: T :: r = return_type}. <b>Note:</b> This opcode should only ever be
     * used in the first instruction of a block following a non-invoke throwing insn
     */
