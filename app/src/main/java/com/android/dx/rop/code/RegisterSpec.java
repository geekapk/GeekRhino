...
public final class RegisterSpec implements TypeBearer, ToHuman, Comparable<RegisterSpec> {
    ...
    /**
     * Returns an instance for the given register number and type, with no variable info. This
     * method is allowed to return shared instances (but doesn't necessarily do so).
     *
     * @param reg {@code >= 0;} the register number
     * @param type {@code non-null;} the type (or possibly actual value) which is loaded from or
     *     stored to the indicated register
    ...
    /**
     * Helper for {@link #hashCode} and {@link #ForComparison.hashCode}, which actually does the
     * calculation.
     *
    ...
    /**
     * Gets the type (or actual value) which is loaded from or stored to the register associated
     * with this instance.
     *
    ...
    /**
     * Gets whether this instance's type is category 1. This is just a convenient shorthand for
     * {@code getType().isCategory1()}.
     *
     * @see #getCategory
     * @see #isCategory2
    ...
    /**
     * Gets whether this instance's type is category 2. This is just a convenient shorthand for
     * {@code getType().isCategory2()}.
     *
     * @see #getCategory
     * @see #isCategory1
     ...
     *   <li>If the locals are {@code equals()}, then the local info of the intersection is the
     *       local info of this instance. Otherwise, the local info of the intersection is {@code
     *       null}.
     * </ul>
     *
    ...
    /**
     * Returns an instance that is identical to this one, except that the register number is
    ...
    /**
     * Returns an instance that is identical to this one, except that the register number is offset
     * by the given amount.
     *
     ...
     * the actual underlying type (thereby stripping off non-type information) with any
