...
public final class RegisterSpecList extends FixedSizeList implements TypeList {
    ...
    public static RegisterSpecList make(
            RegisterSpec spec0, RegisterSpec spec1, RegisterSpec spec2) {
    ...
    /**
     * Gets the indicated element. It is an error to call this with the index for an element which
     * was never set; if you do that, this will throw {@code NullPointerException}.
     *
    ...
    /**
     * Returns a RegisterSpec in this list that uses the specified register, or null if there is
     * none in this list.
     *
    ...
    /**
     * Gets the minimum required register count implied by this instance. This is equal to the
     * highest register number referred to plus the widest width (largest category) of the type used
     * in that register.
     *
    ...
    /**
     * Returns a new instance, which contains a subset of the elements specified by the given
     * BitSet. Indexes in the BitSet with a zero are included, while indexes with a one are
     * excluded. Mutability of the result is inherited from the original.
     *
    ...
    /**
     * Returns an instance that is identical to this one, except that all register numbers are
     * offset by the given amount. Mutability of the result is inherited from the original.
     *
