...
public final class RegisterSpecSet extends MutabilityControl {
    ...
    /**
     * {@code non-null;} array of register specs, where each element is {@code null} or is an
     * instance whose {@code reg} matches the array index
     */
     ...
     *
     * @param maxSize {@code >= 0;} the maximum register number (exclusive) that may be represented
     *     in this instance
     */
     ...
     * @return {@code null-ok;} the element with the given register number or {@code null} if there
     *     is none
     */
     ...
     * @return {@code null-ok;} the element with the matching register number or {@code null} if
     *     there is none
     */
    ...
    /**
     * Intersects this instance with the given one, modifying this instance. The intersection
     * consists of the pairwise {@link RegisterSpec#intersect} of corresponding elements from this
     * instance and the given one where both are non-null.
     *
