...
public final class Rop {
     ...
     * @param result {@code non-null;} result type of this operation; {@link Type#VOID} for
    ...
    /**
     * Gets the result type. A return value of {@link Type#VOID} means this operation returns
     * nothing.
     *
     ...
     * All commutative Rops have exactly two sources and have no branchiness.
     *
    ...
    /**
     * Gets the nickname. If this instance has no nickname, this returns the result of calling
     * {@link #toString}.
     *
    ...
    /**
     * Gets whether this operation can possibly throw an exception. This is just a convenient
     * wrapper for {@code getExceptions().size() != 0}.
     *
