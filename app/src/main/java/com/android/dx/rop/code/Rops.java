...
public final class Rops {
    ...
    /**
     * {@code T: any non-array object type; x: Object :: (T) x} (can throw {@code
     * ClassCastException})
     */
     ...
     *
     * <p><b>Note:</b> This method does not do complete error checking on its arguments, and so it
     * may return an instance which seemed "right enough" even though in actuality the passed
     * arguments don't quite match what is returned. TODO: Revisit this issue.
     *
    ...
    /**
     * Returns the appropriate {@code move-result} rop for the given type. The result may be a
     * shared instance.
     *
    ...
    /**
     * Returns the appropriate {@code move-result-pseudo} rop for the given type. The result may be
     * a shared instance.
     *
     * @param type {@code non-null;} type of the parameter
     * @return {@code non-null;} an appropriate instance
    ...
    /**
     * Returns the appropriate {@code const} rop for the given type. The result is a shared
     * instance.
     *
    ...
    /**
     * Returns the appropriate {@code ushr} rop for the given types. The result is a shared
     * instance.
     *
     * @param types {@code non-null;} types of the sources
     * @return {@code non-null;} an appropriate instance
    ...
    /**
     * Returns the appropriate binary arithmetic rop for the given type and arguments. The result is
     * a shared instance.
     *
    ...
    /**
     * Returns the appropriate {@code conv} rop for the given types. The result is a shared
     * instance.
     *
    ...
    /**
     * Returns the appropriate {@code return} rop for the given type. The result is a shared
     * instance.
     *
    ...
    /**
     * Returns the appropriate {@code invoke-static} rop for the given type. The result is typically
    ...
    /**
     * Returns the appropriate {@code invoke-virtual} rop for the given type. The result is
    ...
    /**
     * Returns the appropriate {@code invoke-super} rop for the given type. The result is typically
     * a newly-allocated instance.
     *
     * @param meth {@code non-null;} descriptor of the method, including the {@code this} parameter
     * @return {@code non-null;} an appropriate instance
    ...
    /**
     * Returns the appropriate {@code invoke-direct} rop for the given type. The result is typically
     * a newly-allocated instance.
     *
     * @param meth {@code non-null;} descriptor of the method, including the {@code this} parameter
     * @return {@code non-null;} an appropriate instance
