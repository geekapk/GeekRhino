...
public abstract class CstBaseMethodRef extends CstMemberRef {
    ...
    /**
     * {@code null-ok;} the prototype for this method taken to be an instance method, or {@code
    ...
    /**
     * Gets the prototype of this method as either a {@code static} or instance method. In the case
     * of a {@code static} method, this is the same as the raw prototype. In the case of an instance
    ...
    /**
     * Gets the number of words of parameters required by this method's descriptor. Since instances
     * of this class have no way to know if they will be used in a {@code static} or instance
     * context, one has to indicate this explicitly as an argument. This method is just a convenient
     * shorthand for {@code getPrototype().getParameterTypes().getWordCount()}, plus {@code 1} if
     * the method is to be treated as an instance method.
     *
     * @param isStatic whether the method should be considered static
