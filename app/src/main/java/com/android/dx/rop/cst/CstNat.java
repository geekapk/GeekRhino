...
public final class CstNat extends Constant {
    ...
    /**
     * Gets whether this instance has the name of a standard class initialization method. This is
     * just a convenient shorthand for {@code getName().getString().equals("<clinit>")}.
     *
     * @return {@code true} iff this is a reference to an instance initialization method
     */
