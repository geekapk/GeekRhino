...
public final class CstType extends TypedConstant {
     ...
     * primitive type. For example, if given {@link Type#INT}, this method returns the class
     * reference {@code java.lang.Integer}.
     *
    ...
    /**
     * Gets the underlying type (as opposed to the type corresponding to this instance as a
     * constant, which is always {@code Class}).
     *
     ...
     * type, this returns the package name of the array's component type. If this is a primitive
     * type, this returns "default".
     */
