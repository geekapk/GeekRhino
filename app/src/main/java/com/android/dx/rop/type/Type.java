...
public final class Type implements TypeBearer, Comparable<Type> {
    ...
    /**
     * {@code non-null;} instance representing {@code java.lang.Boolean}; the suffix on the name
    ...
    /**
     * {@code non-null;} instance representing {@code java.lang.Double}; the suffix on the name
     * helps disambiguate this from the instance representing a primitive type
     */
    ...
    /**
     * {@code non-null;} instance representing {@code java.lang.Integer}; the suffix on the name
     * helps disambiguate this from the instance representing a primitive type
     */
    ...
    /**
     * {@code null-ok;} the type corresponding to elements of this type, if calculated; only valid
     * if {@code this} is an array type
     */
     ...
     * Calling this method is equivalent to calling {@code intern(name)} if {@code name} begins with
     * {@code "["} and calling {@code intern("L" + name + ";")} in all other cases.
     *
    ...
    /**
     * Constructs an instance corresponding to an "uninitialized type." This is a private
     * constructor; use one of the public static methods to get instances.
     *
    ...
    /**
     * Gets the category. Most instances are category 1. {@code long} and {@code double} are the
     * only category 2 types.
     *
     * @see #isCategory1
     * @see #isCategory2
     * @return the category
    ...
    /**
     * Gets whether this type is "intlike." An intlike type is one which, when placed on a stack or
     * in a local, is automatically converted to an {@code int}.
     *
    ...
    /**
     * Gets whether this type is a primitive type. All types are either primitive or reference
     * types.
     *
    ...
    /**
     * Gets whether this type is a normal reference type. A normal reference type is a reference
     * type that is not a return address. This method is just convenient shorthand for {@code
    ...
    /**
     * Gets whether this type is an array type or is a known-null, and hence is compatible with
     * array types.
     *
     * @return whether this type is an array type
     */
    ...
    /**
     * Gets whether this type represents an uninitialized instance. An uninitialized instance is
     * what one gets back from the {@code new} opcode, and remains uninitialized until a valid
     ...
     * Integer.MAX_VALUE} if this type is an uninitialized incoming parameter (i.e., the {@code
     * this} of an {@code <init>} method) or {@code -1} if this type is in fact <i>initialized</i>.
     *
    ...
    /**
     * Gets the initialized type corresponding to this instance, but only if this instance is in
     * fact an uninitialized object type.
     *
