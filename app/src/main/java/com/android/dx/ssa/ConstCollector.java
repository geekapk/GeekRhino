...
public class ConstCollector {
    ...
    /**
     * Also collect string consts, although they can throw exceptions. This is off now because it
     * just doesn't seem to gain a whole lot. TODO if you turn this on, you must change
     * SsaInsn.hasSideEffect() to return false for const-string insns whose exceptions are not
    ...
    /**
     * Inserts mark-locals if necessary when changing a register. If the definition of {@code
     * origReg} is associated with a local variable, then insert a mark-local for {@code newReg}
     * just below it. We expect the definition of {@code origReg} to ultimately be removed by the
