...
public class DeadCodeRemover {
    ...
    private static class NoSideEffectVisitor implements SsaInsn.Visitor {
        ...
        /**
         * Passes in data structures that will be filled out after ssaMeth.forEachInsn() is called
         * with this instance.
         *
         * @param noSideEffectRegs to-build bitset of regs that are results of regs with no side
         *     effects
         */
