 ...
 *
 * <p>See A Fast Algorithm for Finding Dominators in a Flowgraph T. Lengauer & R. Tarjan, ACM TOPLAS
...
public final class Dominators {
    ...
    private static final class DFSInfo {
        ...
        /**
         * rep(resentative) is known as "label" in the paper. It is the node that our block's DFS
         * info has been unioned to.
         */
