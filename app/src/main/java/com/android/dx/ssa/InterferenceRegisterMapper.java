...
public class InterferenceRegisterMapper extends BasicRegisterMapper {
     ...
     * nothing.
     *
     * <p>Bit sets are always used here, unlike elsewhere, because the max size of this matrix will
     * be (countSsaRegs * countRopRegs), which may grow to hundreds of K but not megabytes.
     */
    ...
    /**
     * Checks to see if old namespace reg {@code oldReg} interferes with what currently maps to
     * {@code newReg}.
     *
     ...
     * @param targetCategory {@code 1..2;} the number of adjacent new-namespace registers (starting
     *     at ropReg) to consider
