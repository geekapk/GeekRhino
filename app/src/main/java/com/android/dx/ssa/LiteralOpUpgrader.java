...
public class LiteralOpUpgrader {
                    ...
                    public void visitNonMoveInsn(NormalSsaInsn insn) {
                        ...
                        if (opcode.getBranchingness() == Rop.BRANCH_IF) {
                            ...
                            if (isConstIntZeroOrKnownNull(sources.get(0))) {
                                ...
                                replacePlainInsn(
                                        insn, sources.withoutLast(), opcode.getOpcode(), null);
                            }
                            ...
                            insn.setNewSources(
                                    RegisterSpecList.make(sources.get(1), sources.get(0)));
    ...
    private void replacePlainInsn(
        ...
        if (cst == null) {
            newRopInsn =
                    new PlainInsn(
                            newRop, originalRopInsn.getPosition(), insn.getResult(), newSources);
        } else {
            newRopInsn =
                    new PlainCstInsn(
                            newRop,
