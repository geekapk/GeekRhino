...
/**
 * Container for local variable information for a particular {@link com.android.dx.ssa.SsaMethod}.
...
public class LocalVariableInfo extends MutabilityControl {
    ...
    /**
     * {@code non-null;} {@link com.android.dx.rop.code.RegisterSpecSet} to use when indicating a
     ...
     * already assigned upon entry to each block, where array indices correspond to block indices
     */
    ...
    /**
     * Merges the given register set into the set for the block with the given index. If there was
    ...
    /**
     * Gets the register set associated with the start of the block with the given index. This
     ...
     * index. This returns a newly-allocated empty {@link RegisterSpecSet} of appropriate max size
    ...
    /**
     * Helper method, to get the starts for a index, throwing the right exception for range
     * problems.
     *
     * @param index {@code >= 0;} the block index
