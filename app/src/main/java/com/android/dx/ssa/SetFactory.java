...
public final class SetFactory {
    ...
    /**
     * BitIntSet/ListIntSet threshold for dominance frontier sets. These sets are kept per basic
     * block until phi placement and tend to be, like the CFG itself, very sparse at large sizes.
     *
