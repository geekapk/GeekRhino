...
public class SsaToRop {
     ...
     * @param minimizeRegisters {@code true} if the converter should attempt to minimize the
     *     rop-form register count
    ...
    /**
     * Removes all blocks containing only GOTOs from the control flow. Although much of this work
     * will be done later when converting from rop to dex, not all simplification cases can be
     * handled there. Furthermore, any no-op block between the exit block and blocks containing the
     * real return or throw statements must be removed.
     */
    ...
    /**
     * Moves the parameter registers, which allocateRegisters() places at the bottom of the frame,
     * up to the top of the frame to match Dalvik calling convention.
     */
    private void moveParametersToHighRegisters() {
        ...
        if (DEBUG) {
            System.out.printf(
                    "Moving %d registers from 0 to %d\n", paramWidth, regCount - paramWidth);
        }
