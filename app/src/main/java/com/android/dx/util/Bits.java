...
public final class Bits {
     ...
     * @return {@code >= -1;} lowest-order bit set at or after {@code idx}, or {@code -1} if there
     *     is no appropriate bit index to return
     */
     ...
     *
     * @param a {@code non-null;} int array to be ored with other argument. This argument is
     *     modified.
     * @param b {@code non-null;} int array to be ored into {@code a}. This argument is not
     *     modified.
     */
