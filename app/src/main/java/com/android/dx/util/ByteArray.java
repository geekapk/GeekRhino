...
public final class ByteArray {
    ...
    /**
     * Copies the contents of this instance into the given raw {@code byte[]} at the given offset.
     * The given array must be large enough.
     *
    ...
    private void checkOffsets(int s, int e) {
        if ((s < 0) || (e < s) || (e > size)) {
            throw new IllegalArgumentException(
                    "bad range: " + s + ".." + e + "; actual size " + size);
        }
    }
    ...
    /**
     * Gets the {@code unsigned byte} value at the given offset, without doing any argument
     * checking.
     *
     * @param off offset to fetch
     * @return byte at that offset
