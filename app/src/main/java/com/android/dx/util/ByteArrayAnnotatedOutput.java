...
public final class ByteArrayAnnotatedOutput implements AnnotatedOutput, ByteOutput {
    ...
    /**
     * Finishes up annotation processing. This closes off any open annotations and removes
    ...
    /**
     * Reallocates the underlying array if necessary. Calls to this method should be guarded by a
     * test of {@link #stretchy}.
     *
    ...
    private static class Annotation {
         ...
         * @param end {@code >= start;} end of annotated range (exclusive) or {@code
