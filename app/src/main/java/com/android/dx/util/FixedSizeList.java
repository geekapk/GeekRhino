...
public class FixedSizeList extends MutabilityControl implements ToHuman {
     ...
     * was never set; if you do that, this will throw {@code NullPointerException}. This method is
    ...
    /**
     * Gets the indicated element, allowing {@code null}s to be returned. This method is protected
     * so that subclasses may (optionally) offer a safe type-checked public interface to their
     * clients.
     *
     * @param n {@code >= 0, < size();} which element
     ...
     * method is protected so that subclasses may offer a safe type-checked public interface to
     * their clients.
     *
     * @param n {@code >= 0, < size();} which element
