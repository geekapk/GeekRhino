...
public class LabeledList extends FixedSizeList {
    ...
    public final int getMaxLabel() {
        ...
        int i;
        for (i = sz - 1; (i >= 0) && (labelToIndex.get(i) < 0); i--) /*empty*/ ;
    ...
    /**
     * Gets an array containing all of the labels used in this instance, in order. The returned
     * array is freshly-allocated and so may be modified safely by the caller without impacting this
     * instance.
     *
    ...
    /**
     * Rebuilds the label-to-index mapping after a {@code shrinkToFit()}. Note: This assumes that
     * the labels that are in the list are the same, although the indicies may have changed.
     */
