...
public interface Output extends ByteOutput {
    ...
    /**
     * Writes a DWARFv3-style unsigned LEB128 integer. For details, see the "Dalvik Executable
     * Format" document or DWARF v3 section 7.6.
     *
    ...
    /**
     * Adds extra bytes if necessary (with value {@code 0}) to force alignment of the output cursor
     * as given.
     *
